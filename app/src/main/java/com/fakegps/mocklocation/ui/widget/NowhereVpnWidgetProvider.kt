...
class NowhereVpnWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun updateAllVpnWidgets(context: Context) {
            val intent = Intent(context, NowhereVpnWidgetProvider::class.java).apply {
                action = ACTION_UPDATE_VPN_WIDGET
    ...
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        for (appWidgetId in appWidgetIds) {
            updateVpnWidget(context, appWidgetManager, appWidgetId)
        }
    }
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            ...
            ACTION_UPDATE_VPN_WIDGET, Intent.ACTION_LOCALE_CHANGED, Intent.ACTION_CONFIGURATION_CHANGED -> {
                ...
                for (id in ids) {
                    updateVpnWidget(context, appWidgetManager, id)
                }
            }
        }
    }

    private fun updateVpnWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
